...
public class Identity_SAXparsermsgType8 extends BaseRichBolt {


    String csvFileNameOutSink;  //Full path name of the file at the sink bolt
    public Identity_SAXparsermsgType8(String csvFileNameOutSink){
...
//        collector.emit("RED",new Values(rowString,msgId,String.valueOf(ts2-ts1)));  //addon
        ...
        if(msgType.equals("GREEN"))
            System.out.println("Wromg DATA at bolt Identity_SAXparsermsgType8");
//            collector.emit("GREEN",new Values(rowString,msgId ));
