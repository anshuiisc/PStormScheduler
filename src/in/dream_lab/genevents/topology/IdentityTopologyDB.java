...
import in.dream_lab.genevents.boltsUidai.Identity_DBQuery;
 ...
 */
public class IdentityTopologyDB {
...
//        builder.setSpout("wordspout", new SampleSpout(), 1);
        ...
        builder.setBolt("identity",
                new Identity_DBQuery(sinkLogFileName), 10)
                .shuffleGrouping("spout");

        builder.setBolt("sink", new Sink(sinkLogFileName), 1).shuffleGrouping("identity");
