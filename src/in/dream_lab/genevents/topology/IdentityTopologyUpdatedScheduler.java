...
import in.dream_lab.genevents.boltsUidai.IdentityNext;
 ...
 */
public class IdentityTopologyUpdatedScheduler {
...
//        builder.setSpout("wordspout", new SampleSpout(), 1);
        builder.setSpout("spout", new SampleSpout(argumentClass.getInputDatasetPathName(), spoutLogFileName, argumentClass.getScalingFactor()), 1).addConfiguration("site", "tamu");


        builder.setBolt("identity", new Identity(sinkLogFileName), 1).shuffleGrouping("spout").addConfiguration("site", "tamu");
        builder.setBolt("identitynext", new IdentityNext(sinkLogFileName), 1).shuffleGrouping("identity").addConfiguration("site", "uh");
        builder.setBolt("sink", new Sink(sinkLogFileName), 1).shuffleGrouping("identitynext").addConfiguration("site", "ufl");;
