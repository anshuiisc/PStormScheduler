...
public class IdentityFloatmsgType5 extends BaseRichBolt {


    String csvFileNameOutSink;  //Full path name of the file at the sink bolt
    public IdentityFloatmsgType5(String csvFileNameOutSink){
...
//        collector.emit("RED",new Values(rowString,msgId,String.valueOf(ts2-ts1)));  //addon
        ...
        if(msgType.equals("RED"))
            System.out.println("wrong DATA at bolt IdentityFloatmsgType5");
