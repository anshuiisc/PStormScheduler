...
import in.dream_lab.genevents.boltsUidai.Identity_SAXparser;
 ...
 */
public class IdentityTopologyParse {
...
//        builder.setSpout("wordspout", new SampleSpout(), 1);
        builder.setSpout("spout", new SampleSpout(argumentClass.getInputDatasetPathName(), spoutLogFileName, argumentClass.getScalingFactor()),
                1)
                .addConfiguration("site", "tamu");
        builder.setBolt("identity",
                new Identity_SAXparser(sinkLogFileName), 1)
                .shuffleGrouping("spout").addConfiguration("site", "uh");
        builder.setBolt("sink", new Sink(sinkLogFileName), 1).shuffleGrouping("identity")      .addConfiguration("site", "tamu");
