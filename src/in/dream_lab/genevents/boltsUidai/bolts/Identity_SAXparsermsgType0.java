...
public class Identity_SAXparsermsgType0 extends BaseRichBolt {


    String csvFileNameOutSink;  //Full path name of the file at the sink bolt
    public Identity_SAXparsermsgType0(String csvFileNameOutSink){
...
//        collector.emit("RED",new Values(rowString,msgId,String.valueOf(ts2-ts1)));  //addon
        ...
        System.out.println("MessagetypeParse"+ msgType);
