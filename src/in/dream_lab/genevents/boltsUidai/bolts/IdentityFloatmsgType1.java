...
public class IdentityFloatmsgType1 extends BaseRichBolt {


    String csvFileNameOutSink;  //Full path name of the file at the sink bolt
    public IdentityFloatmsgType1(String csvFileNameOutSink){
