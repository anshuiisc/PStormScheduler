...
public class Identity_SAXparsermsgType6 extends BaseRichBolt {


    String csvFileNameOutSink;  //Full path name of the file at the sink bolt
    public Identity_SAXparsermsgType6(String csvFileNameOutSink){
...
//        collector.emit("RED",new Values(rowString,msgId,String.valueOf(ts2-ts1)));  //addon
        ...
        if(msgType.equals("RED"))
            System.out.println("Wrong DATA at Identity_SAXparsermsgType6");
//            collector.emit("RED",new Values(rowString,msgId ));
