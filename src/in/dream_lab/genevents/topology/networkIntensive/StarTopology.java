package in.dream_lab.genevents.topology.networkIntensive;
...
//        builder.setSpout("wordspout", new SampleSpout(), 1);
        ...
        builder.setSpout("spout2", new SampleSpout(argumentClass.getInputDatasetPathName(), spoutLogFileName, argumentClass.getScalingFactor()),
                1)
        ;

        builder.setBolt("identity1",
                new Identity(sinkLogFileName), 1)
                .shuffleGrouping("spout1").shuffleGrouping("spout2");

        builder.setBolt("identity2",
                new Identity(sinkLogFileName), 1)
                .shuffleGrouping("identity1");
        ...
        builder.setBolt("sink", new Sink(sinkLogFileName), 1)
                .shuffleGrouping("identity2").shuffleGrouping("identity3");
