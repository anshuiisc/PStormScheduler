...
import in.dream_lab.genevents.api.PacketValidationAPI;
import in.dream_lab.genevents.logging.BatchedFileLogging;

import java.util.Map;

public class PacketValidationBolt implements IRichBolt {
    private final String experiRunId;
    OutputCollector _collector;
    int count_dedup=1;

    public PacketValidationBolt(String sinkLogFileName) {
    ...
    public void execute(Tuple tuple) {
        PacketValidationAPI.packetValidation();
//        PacketValidationAPI.packteOSIValidation();
...
//        _collector.emit(tuple, new Values(tuple.getString(0) + " PacketValidationBolt"));
    }
